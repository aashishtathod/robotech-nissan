...
class _StockScreenState extends State<StockScreen> {
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: !submitButtonVisible
                                ...
                                : () async {
                                    updateStatus(
                                        vin, groupCode, dealerCode, dealerName);
                                  },
    ...
    controller.scannedDataStream.listen((scanData) {
      setState(() {
        ...
        if (result != null) {
          ...
          vin = (result!.code!.contains("#")
              ? result!.code!.substring(result!.code!.indexOf("#") + 1, result!.code!.indexOf("#") + 18)
              : result!.code)!;
        }
      });
    });
  ...
  checkStatus(vin, dealerCode) async {
    var data = {'type': 'Stock', 'vin': vin, 'dealerCode': dealerCode};
